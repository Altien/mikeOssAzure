...
// Static-export divergence (OSS-5): split out of page.tsx as a client
// section. projectId comes from the workspace context (resolved from the URL
// by ProjectWorkspaceLayout), not from server-baked params.
